   ...
   <div class="place">
	...
	<table>
		<tr>
			<td width="59%"></td>
			<td>
			<form action="lookUpDateFinish.action?pageSize=1" method="post">											         
    ...
    <div class="ui_tb_h30">
			<table border="1px" width="100%">
				<tr>
					...
					<div class="ui_frt">
					<c:if test="${pSize>1 }">						
					<a href="lookUpDateFinish.action?pageSize=1&comdate1=${requestScope.comdate3}&comdate2=${requestScope.comdate4}"><input type="button" value="首页" class="ui_input_btn01" /></a>
					<a href="lookUpDateFinish.action?pageSize=${requestScope.pSize-1}&comdate1=${requestScope.comdate3}&comdate2=${requestScope.comdate4}"><input type="button" value="上一页" class="ui_input_btn01" /></a>
					</c:if>
					<c:if test="${pSize<page }">
					<a href="lookUpDateFinish.action?pageSize=${requestScope.pSize+1}&comdate1=${requestScope.comdate3}&comdate2=${requestScope.comdate4}"><input type="button" value="下一页" class="ui_input_btn01"/></a>
					<a href="lookUpDateFinish.action?pageSize=${requestScope.page}&comdate1=${requestScope.comdate3}&comdate2=${requestScope.comdate4}"><input type="button" value="尾页" class="ui_input_btn01" /></a>	
					</c:if>					
					</div>
					</td>
				</tr>
