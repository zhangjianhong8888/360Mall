...
<html>
  <head>
	...
	<script type="text/javascript" src="/360Mall/css/date/jquery.min.js"></script>
	<script type="text/javascript" src="/360Mall/css/date/jquery.easyui.min.js"></script>
	<script type="text/javascript" src="/360Mall/css/date/easyui-lang-zh_CN.js"></script>
	<style type="text/css">
		.ui_input_btn01zhang {
					width: 80px;
					height: 30px;
    ...
    <div class="ui_tb_h30">
			<table border="1px" width="100%">
				<tr>
					...
					<div class="ui_frt">
					<c:if test="${pSize>1 }">						
					<a href="getAllComplain.action?pageSize=1"><input type="button" value="首页" class="ui_input_btn01" /></a>
					<a href="getAllComplain.action?pageSize=${requestScope.pSize-1}"><input type="button" value="上一页" class="ui_input_btn01" /></a>
					</c:if>
					<c:if test="${pSize<page }">
					<a href="getAllComplain.action?pageSize=${requestScope.pSize+1}"><input type="button" value="下一页" class="ui_input_btn01"/></a>
					<a href="getAllComplain.action?pageSize=${requestScope.page}"><input type="button" value="尾页" class="ui_input_btn01" /></a>	
					</c:if>					
					</div>
					</td>
				</tr>
